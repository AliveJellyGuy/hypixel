  ...
  .:
    dependencies:
      '@minecraft/server-admin':
        specifier: ^1.0.0-beta.1.20.70-preview.22
      ...
      '@minecraft/server-net':
        ...
        version: 1.0.0-beta.11940b24
      '@minecraft/server-ui':
        specifier: 1.2.0-beta.1.21.10-preview.20
        version: 1.2.0-beta.1.21.10-preview.20
      tsc:
        specifier: ^2.0.4
        version: 2.0.4
    devDependencies:
      '@minecraft/server':
        specifier: 1.11.0-beta.1.20.80-stable
        version: 1.11.0-beta.1.20.80-stable
      '@types/node':
        specifier: ^20.11.16
        version: 20.12.12
      gulp:
      ...
      gulp-typescript:
        ...
        version: 6.0.0-alpha.1(typescript@5.4.5)
      typescript:
        specifier: ^5.2.2
        version: 5.4.5
...
packages:
  ...
  '@minecraft/common@1.2.0':
    resolution: {integrity: sha512-JdmEq4P3Z/FtoBzhLijFgMSVFnFRrUoLwY8DHHrgtFo0mfLTOLTB1RErYjLMsA6b7BGVNxkX/pfFRiH7QZ0XwQ==}

  '@minecraft/server-admin@1.0.0-beta.11940b24':
    resolution: {integrity: sha512-UZ8YyB8mvF31f22+uM67gJums9d6NDgz9AQ2l4a++EHUP9uen0m3aaBaqM9RyumJpRBJbv/hslAKOyeDT01qew==}

  '@minecraft/server-gametest@1.0.0-beta.1.20.80-stable':
    resolution: {integrity: sha512-Vel8vMD7HPeXPuRQyf3oPjq7eVZvLFovjDsvs19grRs6e4K7zoiHRvsUnpCtcOJhZook5NiOtdpm0PrJbymNUA==}

  '@minecraft/server-net@1.0.0-beta.11940b24':
    resolution: {integrity: sha512-jiL03mGNpADCfvPDyydheEAhdi7J++nx5nB7Gyu3GImDlV5pv9uTwKCrnmILrLs4qJTtxhuRLKBKRlVyYDpKMw==}

  '@minecraft/server-ui@1.2.0-beta.1.21.10-preview.20':
    resolution: {integrity: sha512-X4EnJwb6Da8lkUe2MxFcfYZpfYDcpUUDCDBJn8wBg+lqKPHos6j15Ic5IQFGYfCjg2DGkV+cWZYvzgGnL9Ifgw==}

  '@minecraft/server@1.10.0':
    resolution: {integrity: sha512-liBalm1XKMtf7LPyKZ4VcuwxAbprKcAHnG6b0VUdULezOz/RFj2gqmfyA0qE8azMMa8KVPmnl7hYq4KjoGZmmA==}

  '@minecraft/server@1.11.0-beta.1.20.80-stable':
    resolution: {integrity: sha512-nedguYKlNHbwe34YlmwF4R1K3ZDW3qzD7xnxODt9PuSwyFfmQzTG0JbN6ulBrMdE60VwQ3qBr46sGO6xtaNJSA==}
...
snapshots:
  ...
  gulp-typescript@6.0.0-alpha.1(typescript@5.4.5):
    dependencies:
      ansi-colors: 4.1.3
      plugin-error: 1.0.1
      source-map: 0.7.4
